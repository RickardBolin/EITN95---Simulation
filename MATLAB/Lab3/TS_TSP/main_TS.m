...
d = reshape(sqrt(sum((xy(a,:)-xy(a',:)).^2,2)),nPoints,nPoints);
%%
d_orig = d; 
...
%% set maximum Tabu Tenure and maximum number of iterations
max_tabu_tenure = round(sqrt(dim1)); % maximum tabu tenure
